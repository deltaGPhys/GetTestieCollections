...
//        return (this.yearOfBirth < person2.getYearOfBirth()) ? -1 : (this.yearOfBirth == person2.getYearOfBirth()) ? 0 : 1;
        return Integer.compare(this.yearOfBirth, person2.getYearOfBirth());
    }
}
